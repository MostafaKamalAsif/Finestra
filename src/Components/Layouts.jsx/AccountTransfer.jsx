  ...
  return (
    <>
      <div className="my-3.5 ">
        <div className="pt-16 pb-[100px] px-2.5 md:pt-32 md:pb-[140px] md:px-[106px] bg-[#F8F8F8] dark:bg-[#1A1A1A] max-w-[520px] md:max-w-[680px] lg:max-w-[1400px] m-auto rounded-3xl">
          {/* Account transfer  */}
