...
const AccountCard = () => {
  ...
  return (
   <>
   <div className="w-[400px] m-auto md:m-0 md:w-[545px] p-5 md:pt-14 md:pb-14.5 md:px-14 bg-[#EBEBEB] dark:bg-gray-800 rounded-[40px] font-inter scroll-reveal-scale">
